...
- In the read-only browser, elements without identity metadata may be loaded with deterministic derived IDs, but they are marked read-only with a diagnostic.
