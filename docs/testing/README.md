...
- [Test strategy](./test-strategy.md) — Core overview (purpose, principles, test layers)
...
- [Roadmap test coverage tracker](./coverage-tracker.md) — Current frontend/backend coverage, pass evidence, and gaps by roadmap item
